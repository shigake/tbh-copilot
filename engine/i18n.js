...
;(function (g) {
 ...
 const FARM = {
 'en-US': { f_level: 'level', f_stage: 'STAGE', f_clear: 'CLEAR', f_unlock: 'UNLOCK', f_surv: 'surv.', f_calfit: 'calibrated from your real times across {0} stages', f_calone: 'calibrating — farm another stage to lock in the distant ones', f_calnone: 'play a few seconds to calibrate', tab_hist: 'History', d_normal: 'Normal', d_nightmare: 'Nightmare', d_hell: 'Hell', d_torment: 'Torment', f_caledit: 'your clear times', f_caltime: 'seconds', f_caladd: 'add', f_calmax: 'max', f_calextra: 'refine', f_calhint: 'real clear time in seconds · 2+ stages', f_calman: 'calibrated from your {0} entered clear times', f_stages: 'STAGES', f_calneed: '1 entered — add one more stage to apply', refresh_save: 'Re-read the save now', gsl_pre: 'enable up to', gsl_off: 'all', gsl_n: 'nodes', hist_power: 'HISTORY · POWER', hist_gold: 'HISTORY · GOLD', hist_note: 'Builds up as you play.', hist_pow_sum: '{0} samples · POWER {1} → {2} ({3})', hist_gold_sum: 'gold {0} → {1}', hist_collecting: 'Collecting… leave it open while you play.', refreshed: 'Reloaded', refresh_savedat: 'save from {0}', refresh_nosync: "Out of sync? The game hasn't written its save yet." },
 'pt-BR': { f_level: 'nível', f_stage: 'ESTÁGIO', f_clear: 'CLEAR', f_unlock: 'DESTRAVAR', f_surv: 'sobrev.', f_calfit: 'calibrado pelos seus tempos reais em {0} estágios', f_calone: 'calibrando — farme outro estágio pra cravar os distantes', f_calnone: 'jogue uns segundos pra calibrar', tab_hist: 'Histórico', d_normal: 'Normal', d_nightmare: 'Pesadelo', d_hell: 'Inferno', d_torment: 'Tormento', f_caledit: 'seus tempos de clear', f_caltime: 'segundos', f_caladd: 'add', f_calmax: 'máx', f_calextra: 'refinar', f_calhint: 'tempo real de clear em segundos · 2+ estágios', f_calman: 'calibrado pelos seus {0} tempos digitados', f_stages: 'ESTÁGIOS', f_calneed: '1 adicionado — bote mais um estágio pra aplicar', refresh_save: 'Reler o save agora', gsl_pre: 'habilitar até', gsl_off: 'tudo', gsl_n: 'nós', hist_power: 'HISTÓRICO · POWER', hist_gold: 'HISTÓRICO · GOLD', hist_note: 'Acumula enquanto você joga.', hist_pow_sum: '{0} amostras · POWER {1} → {2} ({3})', hist_gold_sum: 'ouro {0} → {1}', hist_collecting: 'Coletando… deixe aberto enquanto joga.', refreshed: 'Recarregado', refresh_savedat: 'save de {0}', refresh_nosync: 'Desincronizado? O jogo ainda não salvou.' },
